...
`fathom-ops-rename-map` is centered on automation work in JavaScript. The technical target is: Develop a JavaScript command-oriented project for rename scenarios with fixture event logs, golden state snapshots, and fixture-scale datasets.
...
The score is deterministic. The current threshold is 150. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 3.
