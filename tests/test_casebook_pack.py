"""Regression checks for the fathom-ops-rename-map casebook."""
...
from casebook.harness import assert_expected, fathom_ops_rename_map_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(fathom_ops_rename_map_summary(), assert_expected())
