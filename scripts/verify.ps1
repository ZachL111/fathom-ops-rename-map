...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom-ops-rename-detail.ps1

node tests/domainReview.test.js

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom-ops-rename-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom-ops-rename-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom_ops_rename_map-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
